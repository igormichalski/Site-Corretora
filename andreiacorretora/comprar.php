...
$sql = "SELECT * FROM imoveis WHERE comprar = 1;";
        ...
        <div class="row">
            ...
            <div class="col-10 d-flex align-items-center">
                <ul class="nav nav-underline">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-black" href="comprar.php">Comprar</a>
                    </li>
                    <li class="nav-item">
...
<div class="container-lg">
    <div class="row">
        ...
        <div class="col-2">
            <h3 align="center"><strong>Imóveis Disponiveis</strong></h3>
            <br>
            <br>
            <br>
        </div>
